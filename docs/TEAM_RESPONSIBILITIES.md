...
- Frontend: candidate profile and resume management interface
...
- Shared HTMX home page and CSS theme
- Shared Docker Compose configuration
- AI Mode, Ollama, and the approved LLM
- Plan -> Act -> Observe -> Adapt workflow
- Integrated testing and showcase preparation
- Architecture diagrams, technical report, and evidence collection

## Tutor confirmation required

The published specification assumes five students and five student workflow files. Confirm and document approval for the four-person team before finalising the architecture and submission plan.
